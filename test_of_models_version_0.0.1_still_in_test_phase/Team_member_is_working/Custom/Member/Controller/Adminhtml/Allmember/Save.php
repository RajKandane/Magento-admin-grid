...
namespace Custom\Member\Controller\Adminhtml\Allmember;

use Magento\Backend\App\Action;
use Custom\Member\Model\Allmember;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Custom\Member\Model\AllmemberFactory
     */
    private $allmemberFactory;

    /**
     * @var \Custom\Member\Api\AllmemberRepositoryInterface
     */
     ...
     * @param \Custom\Member\Model\AllmemberFactory $allmemberFactory
     * @param \Custom\Member\Api\AllmemberRepositoryInterface $allmemberRepository
     */
    public function __construct(
        Action\Context $context,
        DataPersistorInterface $dataPersistor,
        \Custom\Member\Model\AllmemberFactory $allmemberFactory = null,
        \Custom\Member\Api\AllmemberRepositoryInterface $allmemberRepository = null
    ) {
        $this->dataPersistor = $dataPersistor;
        $this->allmemberFactory = $allmemberFactory
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Custom\Member\Model\AllmemberFactory::class);
        $this->allmemberRepository = $allmemberRepository
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Custom\Member\Api\AllmemberRepositoryInterface::class);
	...
	{
		return $this->_authorization->isAllowed('Custom_Member::save');
	}
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Custom\Member\Model\Allmember $model */
