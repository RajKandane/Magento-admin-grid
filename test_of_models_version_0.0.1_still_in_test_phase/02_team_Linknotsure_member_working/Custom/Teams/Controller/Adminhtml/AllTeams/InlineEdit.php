...
use Custom\Teams\Api\AllteamsRepositoryInterface as AllteamsRepository;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    {
        return '[Teams ID: ' . $teams->getId() . '] ' . $errorText;
    }

    public function setTeamsData(\Custom\Teams\Model\Allteams $teams, array $extendedTeamsData, array $teamsData)
    {
