...
use Manage\Member\Model\Allmember;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Manage\Member\Model\AllmemberFactory
     */
    private $allmemberFactory;

    /**
     * @var \Manage\Member\Api\AllmemberRepositoryInterface
     */
     ...
     * @param \Manage\Member\Model\AllmemberFactory $allmemberFactory
     * @param \Manage\Member\Api\AllmemberRepositoryInterface $allmemberRepository
     */
    public function __construct(
        Action\Context $context,
        DataPersistorInterface $dataPersistor,
        \Manage\Member\Model\AllmemberFactory $allmemberFactory = null,
        \Manage\Member\Api\AllmemberRepositoryInterface $allmemberRepository = null
    ) {
        $this->dataPersistor = $dataPersistor;
        $this->allmemberFactory = $allmemberFactory
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Manage\Member\Model\AllmemberFactory::class);
        $this->allmemberRepository = $allmemberRepository
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Manage\Member\Api\AllmemberRepositoryInterface::class);
	...
	{
		return $this->_authorization->isAllowed('Manage_Member::save');
	}
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Manage\Member\Model\Allmember $model */
