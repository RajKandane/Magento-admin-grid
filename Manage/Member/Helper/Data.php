...
namespace Manage\Member\Helper;
...
{
	const XML_PATH_MANAGE_MEMBER = 'manage_member/';
	...
	{
		return $this->getConfigValue(self::XML_PATH_MANAGE_MEMBER.'general/'.$fieldid, $storeCode);
	}

	public function getStorefrontConfig($fieldid, $storeCode = null)
	{
		return $this->getConfigValue(self::XML_PATH_MANAGE_MEMBER.'storefront/'.$fieldid, $storeCode);
	}
